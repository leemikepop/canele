        ...
        if(isset($_SESSION["shoppingcart"])){
            foreach($_SESSION["shoppingcart"] as $key=>$value){
                ...
                echo '<div class="col-3">';
                    ...
                    echo '<input type="text" class="form-control" id="MealNameid'.$key.'" value="'.$result["Name"].'" readonly>';
                echo '</div>';
                echo '<div class="col-3">';
                    echo '<label for="Note" class="col-form-label">說明</label>';
                    echo '<input type="text" class="form-control" value="'.$result["Note"].'" readonly>';
                echo '</div>';
                echo '<div class="col-3">';
                    echo '<label for="Price" class="col-form-label">單價</label>';
                    echo '<input type="text" name="Price'.$key.'" class="form-control" id="Priceid'.$key.'" value="'.$result["Price"].'" readonly>';
                echo '</div>';
                echo '<div class="col-3">';
                    ...
                    echo '<div class="input-group">';
                        ...
                        echo '<input type="text" name="Num'.$key.'" class="form-control Num" id="Numid'.$key.'" pattern="[1-9][0-9]*|[0]" value="'.$value.'">';
